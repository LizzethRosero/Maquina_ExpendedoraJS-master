...
class MaquinaExpendedora {
	constructor() {
		...
		this.p5 = new Producto('50', 'Dorito Mega Queso', 2000);
		this.p6 = new Producto('60', 'Pastel Pinguino Marinela', 3400);
	}
	...
	darProducto5() {
		// Retorna el producto 5
		return this.p5;
	}
	darProducto6() {
		// Retorna el producto 6
		return this.p6;
	}
...
function abastacer_dorito() {
	let cant = prompt("Ingrese el número de unidades que abastecerá el producto");
	m.abastecerProducto5(parseInt(cant));
	let disponible = m.darProducto5().darCantidadUnidadesDisponibles();
	document.getElementById('disp_dorito').innerHTML = 'Disponible: ' + disponible;
}

function abastacer_pastel() {
	let cant = prompt("Ingrese el número de unidades que abastecerá el producto");
...
function unidades_vendidas(){
	...
	let vend_dorito = m.darProducto5().darCantidadUnidadesVendidas();
	let vend_pastel = m.darProducto6().darCantidadUnidadesVendidas();
	alert("La cantidad de unidades vendidas por producto es:\n Papa " + vend_papa
		+ "\n Jugo Hit :" + vend_jugo
		+ "\n Chocolatina jet" + vend_choco
		+ "\n Galletas " + vend_galleta
		+ "\n Galletas " + vend_dorito
		+ "\n Galletas " + vend_pastel
		);
